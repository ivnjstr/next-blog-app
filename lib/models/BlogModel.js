...
const Schema = new mongoose.Schema({
    ...
    // Not required — an author without their own avatar leaves this blank,
    // and the UI shows a generated initials avatar instead of forcing a
    // stand-in stock photo into every post.
    authorImage:{
        type:String,
        default: ""
    },
    ...
    // Not required: existing documents predate this field and are
    // backfilled once by scripts/backfillBlogOwnership.mjs.
    createdBy: {
