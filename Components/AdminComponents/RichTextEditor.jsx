...
const ToolbarButton = ({ onClick, isActive, children, title }) => (
    <button
        ...
        className={`px-3 py-1.5 rounded-lg text-sm font-bold transition-all ${
            isActive ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
        }`}
    >
        {children}
    </button>
...
const RichTextEditor = ({ value, onChange }) => {
    ...
    return (
        <div className='rounded-xl border border-gray-200 dark:border-gray-700 focus-within:border-black dark:focus-within:border-white transition-all overflow-hidden bg-white dark:bg-gray-900'>
            {/* Toolbar */}
            <div className='flex flex-wrap items-center gap-1 px-2 py-2 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50'>
